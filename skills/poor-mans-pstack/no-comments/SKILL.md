...
1. **Spawn the reviewer.** Fire one `no-comments reviewer`-tier `Agent` with the scope and the brief below. Do not restate the brief's rules elsewhere; hand it to the reviewer whole.
